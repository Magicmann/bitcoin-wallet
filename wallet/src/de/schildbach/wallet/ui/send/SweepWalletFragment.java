...
import de.schildbach.wallet.ui.AbstractOnDemandServiceActivity;
...
{
	private AbstractOnDemandServiceActivity activity;
	...
	public void onAttach(final Activity activity)
	{
		...
		this.activity = (AbstractOnDemandServiceActivity) activity;
	...
	private void handleGo()
	{
		...
		new SendCoinsOfflineTask(walletToSweep, backgroundHandler)
		{
			...
			protected void onSuccess(final Transaction transaction)
			{
				...
				activity.processDirectTransaction(sentTransaction);
			}
